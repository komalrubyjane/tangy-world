...
export const mockAgentRequests = [
  {
    ...
    role: 'patron',
    category: 'Booking',
    question: 'I need help changing the quantity on my Vol. 4 ticket.',
    priority: 'normal',
  ...
  {
    id: 'agt-002',
    user: 'Kabir Collective',
    role: 'artist',
    category: 'Artist Application',
    question: 'Following up on our pending application status.',
    priority: 'normal',
  ...
  },
  {
    ...
    question: 'Do you curate heritage experiences for a 60-person wedding?',
    priority: 'high',
    createdAt: '2026-08-11T11:15:00Z',
    status: 'resolved',
    assignedTo: 'Main Team',
