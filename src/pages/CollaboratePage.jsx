      ...
      <section className="bg-[#E7D5A4] border-y-4 border-[#11100C] py-5 sm:py-7 px-4 overflow-x-auto">
        <div className="flex gap-6 sm:gap-0 sm:grid sm:grid-cols-4 max-w-5xl mx-auto text-center min-w-max sm:min-w-0">
          {[
            ...
            { num: '100%', label: 'ECO-FRIENDLY & ZERO PLASTIC' },
            { num: '3', label: 'COLLABORATION TRACKS' },
            { num: '48H', label: 'APPLICATION RESPONSE TIME' }
          ].map((stat, i) => (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 items-center">
              ...
              <div className="md:col-span-2 flex flex-col justify-between h-full">
                <div>
                  ...
                  <p className="font-mono text-xs sm:text-sm leading-relaxed opacity-90 mb-6 border-l-4 border-current pl-4">
                    {track.desc}
                  </p>
