...
export const HeritageExperiencesPage = () => {
    ...
    <div className="min-h-screen bg-[#315D73] text-[#ecdcaf] font-mono selection:bg-[#ecdcaf] selection:text-[#315D73] overflow-x-hidden pt-16 pb-20">
      ...
      <main className="w-full max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-10">
        ...
        <div className="mt-6 mb-8 text-left">
          <span className="font-mono text-[10px] font-bold text-[#d1a437] tracking-[0.3em] uppercase">PRIVATE SESSIONS // CATEGORY 04</span>
          <h1 className="font-poster text-4xl sm:text-6xl text-[#ecdcaf]">HERITAGE EXPERIENCES</h1>
          <p className="font-mono text-xs text-[#ecdcaf]/80 mt-2 max-w-xl">
            Transform your historic palace, stepwell, or haveli into a private music sanctuary — full
            acoustic structural assessment included, with zero structural impact guaranteed.
          </p>
        </div>
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4 font-mono text-xs">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <input required type="text" placeholder="HERITAGE PROPERTY / LOCATION *" value={venue} onChange={(e) => setVenue(e.target.value)} className="p-3 bg-[#241a12] border border-[#ecdcaf]/40 text-[#ecdcaf] focus:outline-none" />
              </div>
