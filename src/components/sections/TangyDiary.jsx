      ...
      <div className="relative w-[min(1100px,94vw)] h-[min(640px,76vh)] preserve-3d">
        ...
        <div className="book-cover-front absolute inset-0 bg-[#2A160F] rounded-xl border-8 border-[#11100C] shadow-[35px_35px_100px_rgba(0,0,0,0.95)] z-40 origin-left flex flex-col justify-between p-8 md:p-16 text-center preserve-3d">
          ...
          <div className="border-b-2 border-[#C99A2E]/50 pb-4 font-mono text-xs text-[#C99A2E] font-bold tracking-[0.3em] uppercase relative z-10">
            PRIVATE ARCHIVE // RESTRICTED ACCESS
          </div>
          ...
          <div className="relative z-10 my-auto">
            ...
            <p className="font-mono text-xs text-[#C99A2E] tracking-[0.4em] uppercase mt-4 font-bold border-y border-[#C99A2E]/40 py-2 inline-block px-6">
              1974 – 2026 // 3D FIELD LOGS
            </p>
          </div>
            ...
            >
              ...
              <div className="w-full md:w-1/2 h-full flex flex-col justify-between items-center border-b-2 md:border-b-0 md:border-r-2 border-[#11100C]/20 pb-6 md:pb-0 md:pr-8">
                ...
                <div className="relative w-full max-w-[340px] bg-[#F5E9C9] p-3 pb-10 shadow-[15px_15px_40px_rgba(0,0,0,0.8)] border border-[#11100C] rotate-[-2deg]">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-20 h-5 bg-[rgba(227,212,172,0.8)] rotate-[2deg] border border-black/20 z-20" />
                  <img src={entry.image} alt={entry.title} className="w-full aspect-[4/3] object-cover filter grayscale sepia-[0.35] contrast-125" />
